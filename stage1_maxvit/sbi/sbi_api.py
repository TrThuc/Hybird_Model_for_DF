...
def make_image_compression(p):
	"""Build JPEG augmentation across Albumentations 1.x and 2.x."""
	try:
		return alb.ImageCompression(quality_range=(40, 100), p=p)
	except TypeError:
...
class SBI_API:
	def __init__(self, phase='train', image_size=256):
		...
		assert phase == 'train', f"SBI_API supports train generation only, got {phase}"
